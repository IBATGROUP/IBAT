...
function Nd(){}
;function Pd(a){return a.j||(a.j=a.v[a.m+a.l]={})}
function Qd(a,b,c){return-1===b?null:b>=a.m?a.j?a.j[b]:void 0:(void 0===c?0:c)&&a.j&&(c=a.j[b],null!=c)?c:a.v[b+a.l]}
function D(a,b,c,d,e){d=void 0===d?!1:d;(void 0===e?0:e)||Dd(a);a.B&&(a.B=void 0);if(b>=a.m||d)return Pd(a)[b]=c,a;void 0!==a.j&&a.m>=a.v.length?(d=a.v.length-1,e=b+a.l,e>=d?(a.v[d]=void 0,a.v[e]=c,a.v.push(a.j)):a.v[e]=c):a.v[b+a.l]=c;void 0!==a.j&&b in a.j&&delete a.j[b];return a}
...
function Wd(a,b,c,d){d=void 0===d?!1:d;var e=d;a.i||(a.i={});var f=a.i[c];if(f)b=f;else if(b=Id(Qd(a,c,e),b))a.i[c]=b,md(b.v,od(a.v)&-33);if(null==b)return b;rd(b.v)&&!rd(a.v)&&(b=b.Bb(),D(a,c,b.v,d),a.i[c]=b);return b}
...
function Yd(a,b,c,d){d=void 0===d?!1:d;var e=rd(a.v);b=Xd(a,b,c,d,e);a=Rd(a,c,0,void 0===d?!1:d);if(!(c=e)&&(c=a)){if(!a)throw Error("cannot check mutability state of non-array");c=!(od(a)&8)}if(c){for(c=0;c<b.length;c++)(d=b[c])&&rd(d.v)&&!e&&(b[c]=b[c].Bb(),a[c]=b[c].v);yd(a,!0)}return b}
...
;function be(a,b,c){a||(a=ce);ce=null;var d=this.constructor.i||0,e=0<d,f=this.constructor.j;a?od(a)&16&&md(a,32):(a=f?[f]:[],md(a,48));e&&0<a.length&&Ad(a[a.length-1])&&"g"in a[a.length-1]&&(d=0);this.l=(f?0:-1)-d;this.i=void 0;this.v=a;a:{f=this.v.length;d=f-1;if(f&&(f=this.v[d],Ad(f))){this.j=f;b=Object.keys(f);0<b.length&&jb(b,isNaN)?this.m=Number.MAX_VALUE:this.m=d-this.l;break a}void 0!==b&&-1<b?(this.m=Math.max(b,d+1-this.l),this.j=void 0):this.m=Number.MAX_VALUE}if(!e&&this.j&&"g"in this.j)throw Error('Unexpected "g" flag in sparse object of message that is not a group type.');
if(c)for(e=0;e<c.length;e++)b=c[e],b<this.m?(b+=this.l,(d=this.v[b])?Array.isArray(d)&&qd(d):this.v[b]=Cd):(d=Pd(this),(f=d[b])?Array.isArray(f)&&qd(f):d[b]=Cd)}
...
function fe(a,b){b.o&&(a.o=b.o.slice());var c=b.i;if(c){b=b.j;for(var d in c){var e=c[d];if(e){var f=!(!b||!b[d]),g=+d;if(Array.isArray(e)){if(e.length)for(f=Yd(a,e[0].constructor,g,f),g=0;g<Math.min(f.length,e.length);g++)fe(f[g],e[g])}else(f=Wd(a,e.constructor,g,f))&&fe(f,e)}}}}
var ce;function ge(a,b,c,d,e,f){(a=a.i&&a.i[c])?Array.isArray(a)?(e=f.ib?qd(a.slice()):a,$d(b,0<e.length?e[0].constructor:void 0,c,e)):G(b,a.constructor,c,a):(gd&&d instanceof Uint8Array?e=d.length?new kd(new Uint8Array(d)):id||(id=new kd(null)):(Array.isArray(d)&&(e?md(d,2):d&&od(d)&1&&f.ib?(e=Array.prototype.slice.call(d),pd(e,(od(d)|0)&-51),d=e):td(d)),e=d),D(b,c,e))}
;function he(){be.apply(this,arguments)}
t(he,be);he.prototype.Bb=function(){return this};
if(Ed){var ie={};Object.defineProperties(he,(ie[Symbol.hasInstance]=Fd(function(){throw Error("Cannot perform instanceof checks for MutableMessage");}),ie))};function je(a){var b=this.i,c=this.j;return this.isRepeated?Yd(a,b,c,!0):Wd(a,b,c,!0)}
;function I(){he.apply(this,arguments)}
t(I,he);I.prototype.Bb=function(){if(rd(this.v)){var a={ib:!0};var b=rd(this.v);if(b&&!a.ib)throw Error("copyRepeatedFields must be true for frozen messages");b||td(this.v);var c=new this.constructor;this.o&&(c.o=this.o.slice());for(var d=this.v,e=0;e<d.length;e++){var f=d[e];if(e===d.length-1&&Ad(f))for(var g in f){var h=+g;Number.isNaN(h)?Pd(c)[g]=f[g]:ge(this,c,h,f[g],b,a)}else ge(this,c,e-this.l,f,b,a)}c.B=this;a=c}else a=this;return a};
if(Ed){var ke={};Object.defineProperties(I,(ke[Symbol.hasInstance]=Fd(Object[Symbol.hasInstance]),ke))};function le(a){this.Lb=a}
;function me(a,b,c){this.j=a;this.m=b;this.i=c||[];this.xa=new Map}
l=me.prototype;l.wc=function(a){var b=Ja.apply(1,arguments),c=this.lb(b);c?c.push(new le(a)):this.kc(a,b)};
l.kc=function(a){this.xa.set(this.Sb(Ja.apply(1,arguments)),[new le(a)])};
...
l.Sb=function(){var a=Ja.apply(0,arguments);return a?a.join(","):"key"};function ne(a,b){me.call(this,a,3,b)}
t(ne,me);ne.prototype.l=function(a){var b=Ja.apply(1,arguments),c=0,d=this.Jc(b);d&&(c=d.Lb);this.kc(c+a,b)};function oe(a,b){me.call(this,a,2,b)}
t(oe,me);oe.prototype.l=function(a){this.wc(a,Ja.apply(1,arguments))};function pe(a){a&&"function"==typeof a.dispose&&a.dispose()}
...
return a[$e]}
;function af(){J.call(this);this.m=new Ke(this);this.tc=this;this.la=null}
...
function bf(a,b){var c=a.la;if(c){var d=[];for(var e=1;c;c=c.la)d.push(c),++e}a=a.tc;c=b.type||b;"string"===typeof b?b=new te(b,a):b instanceof te?b.target=b.target||a:(e=b,b=new te(c,a),yb(b,e));e=!0;if(d)for(var f=d.length-1;!b.l&&0<=f;f--){var g=b.i=d[f];e=cf(g,c,!0,b)&&e}b.l||(g=b.i=a,e=cf(g,c,!0,b)&&e,b.l||(e=cf(g,c,!1,b)&&e));if(d)for(f=0;!b.l&&f<d.length;f++)g=b.i=d[f],e=cf(g,c,!1,b)&&e}
...
l.rd=function(a){this.i=0;zf(this,2,a)};
l.sd=function(a){this.i=0;zf(this,3,a)};
...
function Kf(a){a.s||(a.s=!0,vf(a.Hc,a))}
function Hf(a){var b=null;a.j&&(b=a.j,a.j=b.next,b.next=null);a.j||(a.m=null);return b}
l.Hc=function(){for(var a;a=Hf(this);)If(this,a,this.i,this.B);this.s=!1};
...
Za(Ff,ab);Ff.prototype.name="cancel";function Pf(a,b){af.call(this);this.l=a||1;this.j=b||y;this.o=Wa(this.pd,this);this.s=Date.now()}
Za(Pf,af);l=Pf.prototype;l.enabled=!1;l.ca=null;function Qf(a,b){a.l=b;a.ca&&a.enabled?(a.stop(),a.start()):a.ca&&a.stop()}
l.pd=function(){if(this.enabled){var a=Date.now()-this.s;0<a&&a<.8*this.l?this.ca=this.j.setTimeout(this.o,this.l-a):(this.ca&&(this.j.clearTimeout(this.ca),this.ca=null),bf(this,"tick"),this.enabled&&(this.stop(),this.start()))}};
...
;function Sf(a){this.B=a;this.i=new Map;this.s=new Set;this.l=0;this.m=100;this.flushInterval=3E4;this.j=new Pf(this.flushInterval);this.j.aa("tick",this.gb,!1,this);this.o=!1}
l=Sf.prototype;l.ic=function(a){this.o=a;this.m=1};
...
l.xc=function(a){var b=Ja.apply(1,arguments);this.i.has(a)||this.i.set(a,new ne(a,b))};
l.Ib=function(a){var b=Ja.apply(1,arguments);this.i.has(a)||this.i.set(a,new oe(a,b))};
function Vf(a,b){return a.s.has(b)?void 0:a.i.get(b)}
l.Cb=function(a){this.qc.apply(this,[a,1].concat(ia(Ja.apply(1,arguments))))};
l.qc=function(a,b){var c=Ja.apply(2,arguments),d=Vf(this,a);d&&d instanceof ne&&(d.l(b,c),Tf(this))};
...
;function Wf(a){this.i=a;this.i.Ib("/client_streamz/bg/fil",{kb:3,jb:"rk"})}
function Xf(a){this.i=a;this.i.xc("/client_streamz/bg/fsc",{kb:3,jb:"rk"})}
function Yf(a){this.i=a;this.i.Ib("/client_streamz/bg/fsl",{kb:3,jb:"rk"})}
...
function mg(a){var b=jg();b.update(a);return b.Dc().toLowerCase()}
...
Gg=new Hg;function Jg(a){af.call(this);this.headers=new Map;this.K=a||null;this.j=!1;this.J=this.C=null;this.o=this.T="";this.l=this.R=this.A=this.P=!1;this.s=0;this.G=null;this.da="";this.W=this.X=!1}
Za(Jg,af);var Kg=/^https?$/i,Lg=["POST","PUT"],Mg=[];function Ng(a,b,c,d,e,f,g){var h=new Jg;Mg.push(h);b&&h.aa("complete",b);h.m.add("ready",h.Bc,!0,void 0,void 0);f&&(h.s=Math.max(0,f));g&&(h.X=g);h.send(a,c,d,e)}
l=Jg.prototype;l.Bc=function(){this.dispose();lb(Mg,this)};
l.send=function(a,b,c,d){if(this.C)throw Error("[goog.net.XhrIo] Object is active with another request="+this.T+"; newUri="+a);b=b?b.toUpperCase():"GET";this.T=a;this.o="";this.P=!1;this.j=!0;this.C=this.K?Ig(this.K):Ig(Gg);this.J=this.K?this.K.getOptions():Gg.getOptions();this.C.onreadystatechange=Wa(this.Zb,this);try{this.getStatus(),this.R=!0,this.C.open(b,String(a),!0),this.R=!1}catch(g){this.getStatus();Og(this,g);return}a=c||"";c=new Map(this.headers);if(d)if(Object.getPrototypeOf(d)===Object.prototype)for(var e in d)c.set(e,
...
e=y.FormData&&a instanceof y.FormData;!(0<=eb(Lg,b))||d||e||c.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");b=p(c);for(d=b.next();!d.done;d=b.next())c=p(d.value),d=c.next().value,c=c.next().value,this.C.setRequestHeader(d,c);this.da&&(this.C.responseType=this.da);"withCredentials"in this.C&&this.C.withCredentials!==this.X&&(this.C.withCredentials=this.X);try{Pg(this),0<this.s&&(this.W=Sg(this.C),this.getStatus(),this.W?(this.C.timeout=this.s,this.C.ontimeout=Wa(this.mc,this)):
this.G=Rf(this.mc,this.s,this)),this.getStatus(),this.A=!0,this.C.send(a),this.A=!1}catch(g){this.getStatus(),Og(this,g)}};
function Sg(a){return Mc&&Xc()&&"number"===typeof a.timeout&&void 0!==a.ontimeout}
l.mc=function(){"undefined"!=typeof Ma&&this.C&&(this.o="Timed out after "+this.s+"ms, aborting",this.getStatus(),bf(this,"timeout"),this.abort(8))};
function Og(a,b){a.j=!1;a.C&&(a.l=!0,a.C.abort(),a.l=!1);a.o=b;Tg(a);Ug(a)}
function Tg(a){a.P||(a.P=!0,bf(a,"complete"),bf(a,"error"))}
l.abort=function(){this.C&&this.j&&(this.getStatus(),this.j=!1,this.l=!0,this.C.abort(),this.l=!1,bf(this,"complete"),bf(this,"abort"),Ug(this))};
l.D=function(){this.C&&(this.j&&(this.j=!1,this.l=!0,this.C.abort(),this.l=!1),Ug(this,!0));Jg.Y.D.call(this)};
l.Zb=function(){this.i()||(this.R||this.A||this.l?Vg(this):this.Sc())};
l.Sc=function(){Vg(this)};
function Vg(a){if(a.j&&"undefined"!=typeof Ma)if(a.J[1]&&4==Wg(a)&&2==a.getStatus())a.getStatus();else if(a.A&&4==Wg(a))Rf(a.Zb,0,a);else if(bf(a,"readystatechange"),a.isComplete()){a.getStatus();a.j=!1;try{if(Xg(a))bf(a,"complete"),bf(a,"success");else{try{var b=2<Wg(a)?a.C.statusText:""}catch(c){b=""}a.o=b+" ["+a.getStatus()+"]";Tg(a)}}finally{Ug(a)}}}
function Ug(a,b){if(a.C){Pg(a);var c=a.C,d=a.J[0]?function(){}:null;
a.C=null;a.J=null;b||bf(a,"ready");try{c.onreadystatechange=d}catch(e){}}}
function Pg(a){a.C&&a.W&&(a.C.ontimeout=null);a.G&&(y.clearTimeout(a.G),a.G=null)}
...
function Wg(a){return a.C?a.C.readyState:0}
l.getStatus=function(){try{return 2<Wg(this)?this.C.status:-1}catch(a){return-1}};
...
t(ih,I);var jh;jh=new function(a,b,c){this.j=a;this.fieldName=b;this.i=c;this.isRepeated=0;this.l=je}(175237375,{Hq:0},ih);function kh(a,b,c,d,e,f,g,h,k,m,q){af.call(this);var r=this;this.P="";this.l=[];this.Gb="";this.Hb=this.ra=-1;this.Oa=!1;this.J=this.o=null;this.G=0;this.uc=1;this.timeoutMillis=0;this.da=!1;af.call(this);this.Fb=b||function(){};
this.A=new lh(a,f);this.sc=d;this.Na=q;this.vc=Ya(ff,0,1);this.T=e||null;this.K=c||null;this.W=g||!1;this.pageId=k||null;this.logger=null;this.withCredentials=!h;this.Da=f||!1;!this.Da&&(65<=ac("Chromium")||45<=ac("Firefox")||12<=ac("Safari")||(Gc()||C("iPad")||C("iPod"))&&Hc());a=D(new bh,1,1);mh(this.A,a);this.s=new xg(1E4);this.j=new Pf(this.s.getValue());re(this,this.j);m=nh(this,m);Qe(this.j,"tick",m,!1,this);this.R=new Pf(6E5);re(this,this.R);Qe(this.R,"tick",m,!1,this);this.W||this.R.start();
this.Da||(Qe(document,"visibilitychange",function(){"hidden"===document.visibilityState&&r.X()}),Qe(document,"pagehide",this.X,!1,this))}
...
function oh(a){a.T||(a.T=.01>a.vc()?"https://www.google.com/log?format=json&hasfast=true":"https://play.google.com/log?format=json&hasfast=true");return a.T}
...
kh.prototype.flush=function(a,b){var c=this;if(0===this.l.length)a&&a();else if(this.da)rh(this);else{var d=Date.now();if(this.Hb>d&&this.ra<d)b&&b("throttled");else{var e=sh(this.A,this.l,this.G);d={};var f=this.Fb();f&&(d.Authorization=f);var g=oh(this);this.K&&(d["X-Goog-AuthUser"]=this.K,g=wc(g,"authuser",this.K));this.pageId&&(d["X-Goog-PageId"]=this.pageId,g=wc(g,"pageId",this.pageId));if(f&&this.Gb===f)b&&b("stale-auth-token");else{this.l=[];this.j.enabled&&this.j.stop();this.G=0;var h=de(e),
k;this.J&&this.J.isSupported(h.length)&&(k=this.J.compress(h));var m={url:g,body:h,zc:1,xb:d,requestType:"POST",withCredentials:this.withCredentials,timeoutMillis:this.timeoutMillis},q=function(u){c.s.reset();Qf(c.j,c.s.getValue());if(u){var A=null;try{var E=JSON.parse(u.replace(")]}'\n",""));A=new gh(E)}catch(F){}A&&(u=Number(Sd(A,1,"-1")),0<u&&(c.ra=Date.now(),c.Hb=c.ra+u),A=jh.l(A))&&(A=Sd(A,1,-1),-1!=A&&(c.Oa||ph(c,A)))}a&&a()},r=function(u,A){var E=Yd(e,ch,3),F=c.s;
F.i=Math.min(3E5,2*F.i);F.j=Math.min(3E5,F.i+Math.round(.2*(Math.random()-.5)*F.i));Qf(c.j,c.s.getValue());401===u&&f&&(c.Gb=f);void 0===A&&(A=500<=u&&600>u||401===u||0===u);A&&(c.l=E.concat(c.l),c.W||c.j.enabled||c.j.start());b&&b("net-send-failed",u)},x=function(){c.Na?c.Na.send(m,q,r):c.sc(m,q,r)};
...
function th(a,b){if(0!==a.l.length){var c=Dc(oh(a),"format");c=uc(c,"auth",a.Fb(),"authuser",a.K||"0");for(var d=0;10>d&&a.l.length;++d){var e=a.l.slice(0,32),f=sh(a.A,e,a.G);if(!b(c,f))break;a.G=0;a.l=a.l.slice(e.length)}a.j.enabled&&a.j.stop()}}
...
;function wh(a,b,c){Ng(a.url,function(d){d=d.target;if(Xg(d)){try{var e=d.C?d.C.responseText:""}catch(f){e=""}b(e)}else c(d.getStatus())},a.requestType,a.body,a.xb,a.timeoutMillis,a.withCredentials)}
;function xh(){this.l="https://play.google.com/log?format=json&hasfast=true";this.m=!1;this.s=wh;this.i=""}
;function yh(){var a=void 0===a?"":a;var b=void 0===b?!1:b;var c=void 0===c?"":c;var d=new xh;d.i="";""!=a&&(d.l=a);b&&(d.m=!0);c&&(d.j=c);a=new kh(1828,d.J?d.J:ug,"0",d.s,d.l,d.m,!1,d.R,void 0,void 0,d.B?d.B:void 0);d.A&&mh(a.A,d.A);d.j&&(b=d.j,c=uh(a.A),D(c,7,b));d.o&&(a.J=d.o);d.i&&(a.P=d.i);d.N&&((b=d.N)?(a.o||(a.o=new vg),b=de(b),D(a.o,4,b)):a.o&&D(a.o,4,void 0,!1));d.K&&(b=d.K,a.o||(a.o=new vg),Td(a.o,2,b));d.G&&(b=d.G,a.Oa=!0,ph(a,b));d.P&&vh(a.A,d.P);this.i=a}
yh.prototype.flush=function(a){var b=a||[];if(b.length){a=new gg;for(var c=[],d=0;d<b.length;d++){var e=b[d],f=e;var g=new Zf;g=D(g,1,f.j);for(var h=f,k=[],m=0;m<h.i.length;m++)k.push(h.i[m].jb);g=Td(g,3,k);h=[];k=[];m=p(f.xa.keys());for(var q=m.next();!q.done;q=m.next())k.push(q.value.split(","));for(m=0;m<k.length;m++){q=k[m];var r=f.m;for(var x=f.lb(q)||[],u=[],A=0;A<x.length;A++){var E=x[A];E=E&&E.Lb;var F=new dg;switch(r){case 3:Ud(F,1,fg,Number(E));break;case 2:Ud(F,2,fg,Number(E))}u.push(F)}r=
u;for(x=0;x<r.length;x++){u=r[x];A=new ag;u=G(A,dg,2,u);A=q;E=[];F=f;for(var O=[],N=0;N<F.i.length;N++)O.push(F.i[N].kb);F=O;for(O=0;O<F.length;O++){N=F[O];var R=A[O],ca=new cg;switch(N){case 3:Ud(ca,1,eg,String(R));break;case 2:Ud(ca,2,eg,Number(R));break;case 1:Ud(ca,3,eg,"true"==R)}E.push(ca)}$d(u,cg,1,E);h.push(u)}}$d(g,ag,4,h);c.push(g);e.clear()}$d(a,Zf,1,c);b=this.i;a instanceof ch?b.log(a):(c=new ch,a=de(a),a=D(c,8,a),b.log(a));this.i.flush()}};function zh(){this.o=Ah();this.s=new yh;this.i=new Sf(this.s);this.m=new Wf(this.i);this.j=new Xf(this.i);this.l=new Yf(this.i);this.Aa=window.document.location.hostname}
...
;function Ch(a){var b=this;this.Ua=!1;if(a.Oq){var c;this.sa=null!=(c=a.sa)?c:new zh}c=a.program;a=a.globalName;var d=new Bh;this.j=d.promise;this.nd=p((0,y[a].a)(c,function(e,f){Promise.resolve().then(function(){var g;if(null!=(g=b.sa)){var h=Ah()-g.o;g.m.i.fb("/client_streamz/bg/fil",h,g.Aa)}d.resolve({yc:e,kd:f})})},!0)).next().value;
this.jd=d.promise.then(function(){})}
Ch.prototype.snapshot=function(a){var b=this;if(this.Ua)throw Error("Already disposed");var c=Ah(),d;null!=(d=this.sa)&&d.j.i.Cb("/client_streamz/bg/fsc",d.Aa);return this.j.then(function(e){var f=e.yc;return new Promise(function(g){f(function(h){var k;if(null!=(k=b.sa)){var m=Ah()-c;k.l.i.fb("/client_streamz/bg/fsl",m,k.Aa)}g(h)},[a.Nb,
a.ld])})})};
Ch.prototype.dispose=function(){var a;null!=(a=this.sa)&&a.i.gb();this.Ua=!0;this.j.then(function(b){(b=b.kd)&&b()})};
...
return a}
var Ih={Gd:"allow-forms",Hd:"allow-modals",Id:"allow-orientation-lock",Jd:"allow-pointer-lock",Kd:"allow-popups",Ld:"allow-popups-to-escape-sandbox",Md:"allow-presentation",Nd:"allow-same-origin",Od:"allow-scripts",Pd:"allow-top-navigation",Qd:"allow-top-navigation-by-user-activation"},Kh=db(function(){return Jh()});
...
;var Yh={Wh:"EMBEDDED_PLAYER_MODE_UNKNOWN",Th:"EMBEDDED_PLAYER_MODE_DEFAULT",Vh:"EMBEDDED_PLAYER_MODE_PFP",Uh:"EMBEDDED_PLAYER_MODE_PFL"},Zh={iq:"WEB_DISPLAY_MODE_UNKNOWN",cq:"WEB_DISPLAY_MODE_BROWSER",gq:"WEB_DISPLAY_MODE_MINIMAL_UI",hq:"WEB_DISPLAY_MODE_STANDALONE",fq:"WEB_DISPLAY_MODE_FULLSCREEN"};function $h(){this.data_=[];this.i=-1}
...
t(Rj,I);function mk(a){I.call(this,a,442)}
t(mk,I);
...
353,354,355,356,357,358,361,363,364,368,369,370,373,374,375,378,380,381,388,389,403,410,412,429,413,414,415,416,417,418,430,423,424,425,426,427,431,117,439,441];var ok={Xi:0,Ii:1,Oi:2,Pi:4,Ui:8,Qi:16,Ri:32,Wi:64,Vi:128,Ki:256,Mi:512,Ti:1024,Li:2048,Ni:4096,Ji:8192,Si:16384};function pk(a){I.call(this,a)}
...
;function xl(a,b,c,d,e){qg.set(""+a,b,{Ya:c,path:"/",domain:void 0===d?"youtube.com":d,secure:void 0===e?!1:e})}
function yl(){if(!qg.isEnabled())return!1;if(!qg.isEmpty())return!0;qg.set("TESTCOOKIESENABLED","1",{Ya:60});if("1"!==qg.get("TESTCOOKIESENABLED"))return!1;qg.remove("TESTCOOKIESENABLED");return!0}
...
function Tl(a){var b=new $i,c=new Ti;D(c,1,a.Wb);D(c,2,a.Vb);D(c,16,a.Lc);D(c,17,a.innertubeContextClientVersion);if(a.qb){var d=a.qb,e=new Pi;d.coldConfigData&&D(e,1,d.coldConfigData);d.appInstallData&&D(e,6,d.appInstallData);d.coldHashData&&D(e,3,d.coldHashData);d.hotHashData&&D(e,5,d.hotHashData);G(c,Pi,62,e)}(d=y.devicePixelRatio)&&1!=d&&D(c,65,d);d=Ik();""!==d&&D(c,54,d);d=Jk();if(0<d.length){e=new Vi;for(var f=0;f<d.length;f++){var g=new Ni;D(g,1,d[f].key);g.setValue(d[f].value);ae(e,15,Ni,
...
function Pl(a,b,c){a=a.Ub;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=Wd(b,Qi,96)||new Qi;var d=wl();d=Object.keys(Zh).indexOf(d);d=-1===d?null:d;null!==d&&D(c,3,d);G(b,Qi,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=wl())}
...
function Ul(a,b,c){c=void 0===c?{}:c;var d={};L("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":L("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||L("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Aq||L("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().zq:b=ug([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=L("SESSION_INDEX",0),M("pageid_as_header_web")&&(d["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return d}
...
a);
if("AbortError"===e.name)return new Gm("UNKNOWN_ABORT",a,e.message);e.args=[Object.assign({},a,{name:"IdbError",ac:e.name})];e.level="WARNING";return e}
...
Pm.all=function(a){return new Pm(new Om(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={wa:0};f.wa<a.length;f={wa:f.wa},++f.wa)Pm.resolve(a[f.wa]).then(function(g){return function(h){d[g.wa]=h;e--;0===e&&b(d)}}(f)).catch(function(g){c(g)})}))};
...
;var un=new qn("YtIdbMeta",{Ga:{databases:{hb:1}},upgrade:function(a,b){b(1)&&Zm(a,"databases",{keyPath:"actualName"})}});
...
;function Sn(a){this.Qa=this.i=!1;this.potentialEsfErrorCounter=this.j=0;this.handleError=function(){};
this.za=function(){};
...
a.vb;this.ub=a.ub;Tn(this)&&(!this.I||this.I("networkless_logging"))&&Un(this)}
function Un(a){Tn(a)&&!a.Fa&&(a.i=!0,a.Va&&Math.random()<=a.Ta&&a.O.Ac(a.H),Vn(a),a.M.L()&&a.Ka(),a.M.aa(a.vb,a.Ka.bind(a)),a.M.aa(a.ub,a.Jb.bind(a)))}
...
this.ja(d.url,d.options);this.O.set(d,this.H).then(function(g){d.id=g;e&&c.O.ya(d.id,c.H)}).catch(function(g){Xn(c,g)})}else this.ja(a,b)};
l.Ka=function(){var a=this;if(!Tn(this))throw Lm("throttleSend");this.j||(this.j=this.Z.S(function(){var b;return w(function(c){if(1==c.i)return v(c,a.O.Tb("NEW",a.H),2);if(3!=c.i)return b=c.j,b?v(c,Wn(a,b),3):(a.Jb(),c.return());a.j&&(a.j=0,a.Ka());c.i=0})},this.lc))};
l.Jb=function(){this.Z.fa(this.j);this.j=0};
function Wn(a,b){var c,d;return w(function(e){switch(e.i){case 1:if(!Tn(a))throw c=Lm("immediateSend"),c;if(void 0===b.id){e.u(2);break}return v(e,a.O.Qc(b.id,a.H),3);case 3:(d=e.j)?b=d:a.za(Error("The request cannot be found in the database."));case 2:if(Yn(a,b,a.ec)){e.u(4);break}a.za(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.u(5);break}return v(e,a.O.ya(b.id,a.H),5);case 5:return e.return();case 4:b.skipRetry||(b=Zn(a,b));if(!b){e.u(0);break}if(!b.skipRetry||
...
b.options.onError=function(e,f){var g,h,k;return w(function(m){switch(m.i){case 1:g=$n(f);if(!(a.I&&a.I("nwl_consider_error_code")&&g||a.I&&!a.I("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.ab)){m.u(2);break}if(!a.M.Ia){m.u(3);break}return v(m,a.M.Ia(),3);case 3:if(a.M.L()){m.u(2);break}c(e,f);if(!a.I||!a.I("nwl_consider_error_code")||void 0===(null==(h=b)?void 0:h.id)){m.u(6);break}return v(m,a.O.yb(b.id,a.H,!1),6);case 6:return m.return();case 2:if(a.I&&a.I("nwl_consider_error_code")&&
...
function Vn(a){if(!Tn(a))throw Lm("retryQueuedRequests");a.O.Tb("QUEUED",a.H).then(function(b){b&&!Yn(a,b,a.cc)?a.Z.S(function(){return w(function(c){if(1==c.i)return void 0===b.id?c.u(2):v(c,a.O.yb(b.id,a.H),2);Vn(a);c.i=0})}):a.M.L()&&a.Ka()})}
function Xn(a,b){a.pc&&!a.M.L()?a.pc(b):a.handleError(b)}
function Tn(a){return!!a.H||a.Qa}
...
bo.prototype.toString=function(){return this.topic};var co=B("ytPubsub2Pubsub2Instance")||new K;K.prototype.subscribe=K.prototype.subscribe;K.prototype.unsubscribeByKey=K.prototype.Ca;K.prototype.publish=K.prototype.qa;K.prototype.clear=K.prototype.clear;z("ytPubsub2Pubsub2Instance",co);var eo=B("ytPubsub2Pubsub2SubscribedKeys")||{};z("ytPubsub2Pubsub2SubscribedKeys",eo);var fo=B("ytPubsub2Pubsub2TopicToKeys")||{};z("ytPubsub2Pubsub2TopicToKeys",fo);var go=B("ytPubsub2Pubsub2IsAsync")||{};z("ytPubsub2Pubsub2IsAsync",go);
...
;var Co={},Do=qo("ServiceWorkerLogsDatabase",{Ga:(Co.SWHealthLog={hb:1},Co),Ab:!0,upgrade:function(a,b){b(1)&&Zm(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).i.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
...
l.Ia=function(a){a=Uh(this.j,a);a.then(function(b){M("use_cfr_monitor")&&Mo().requestComplete("generate_204",b)});
return a};
Qo.prototype.sendNetworkCheckRequest=Qo.prototype.Ia;Qo.prototype.listen=Qo.prototype.aa;Qo.prototype.enableErrorFlushing=Qo.prototype.Ec;Qo.prototype.getWindowStatus=Qo.prototype.Kc;Qo.prototype.networkStatusHint=Qo.prototype.ia;Qo.prototype.isNetworkAvailable=Qo.prototype.L;Qo.getInstance=Ro;function So(a){a=void 0===a?{}:a;af.call(this);var b=this;this.j=this.s=0;this.l=Ro();var c=B("yt.networkStatusManager.instance.listen").bind(this.l);c&&(a.cb?(this.cb=a.cb,c("networkstatus-online",function(){To(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){To(b,"publicytnetworkstatus-offline")})):(c("networkstatus-online",function(){bf(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){bf(b,"publicytnetworkstatus-offline")})))}
...
So.prototype.Ia=function(a){var b=this,c;return w(function(d){c=B("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.l);return M("skip_network_check_if_cfr")&&Mo().isEndpointCFR("generate_204")?d.return(new Promise(function(e){var f;b.ia((null==(f=window.navigator)?void 0:f.onLine)||!0);e(b.L())})):c?d.return(c(a)):d.return(!0)})};
function To(a,b){a.cb?a.j?(Xh.fa(a.s),a.s=Xh.S(function(){a.o!==b&&(bf(a,b),a.o=b,a.j=P())},a.cb-(P()-a.j))):(bf(a,b),a.o=b,a.j=P()):bf(a,b)}
;var Uo;function Vo(){Sn.call(this,{O:{Ac:Ao,ya:zo,Tb:wo,Qc:xo,yb:yo,set:uo},M:Wo(),handleError:Nk,za:Ok,ja:Xo,now:P,pc:Po,Z:im(),vb:"publicytnetworkstatus-online",ub:"publicytnetworkstatus-offline",Va:!0,Ta:.1,ab:Hk("potential_esf_error_limit",10),I:M,Fa:!(wm()&&Yo())});this.l=new Bh;M("networkless_immediately_drop_all_requests")&&Bo();Rn("LogsDatabaseV2")}
t(Vo,Sn);function Zo(){var a=B("yt.networklessRequestController.instance");a||(a=new Vo,z("yt.networklessRequestController.instance",a),M("networkless_logging")&&Gn().then(function(b){a.H=b;Un(a);a.l.resolve();a.Va&&Math.random()<=a.Ta&&a.H&&Fo(a.H);M("networkless_immediately_drop_sw_health_store")&&$o(a)}));
return a}
...
function Wo(){Uo||(Uo=new So({Pc:!0,Fc:!0}));return Uo}
...
a.options.onError=function(e,f){var g,h,k;return w(function(m){switch(m.i){case 1:M("use_cfr_monitor")&&Mo().requestComplete(a.url,!1);g=$n(f);if(!(M("nwl_consider_error_code")&&g||!M("nwl_consider_error_code")&&dq()<=Hk("potential_esf_error_limit",10))){m.u(2);break}if(M("skip_checking_network_on_cfr_failure")&&(!M("skip_checking_network_on_cfr_failure")||Mo().isEndpointCFR(a.url))){m.u(3);break}return v(m,ip().Ia(),3);case 3:if(ip().L()){m.u(2);break}c(e,f);if(!M("nwl_consider_error_code")||void 0===
...
function ip(){if(M("use_new_nwl"))return Wo();ep||(ep=new So({Pc:!0,Fc:!0}));return ep}
...
c.onFetchSuccess=function(N,R){am(E);O(N,R)}}try{A&&d.retry&&!d.Yb.bypassNetworkless?(g.method="POST",d.Yb.writeThenSend?M("use_new_nwl_wts")?Zo().writeThenSend(u,g):mp(u,g):M("use_new_nwl_saw")?Zo().sendAndWrite(u,g):qp(u,g)):(g.method="POST",g.postParams||(g.postParams={}),nl(u,g))}catch(N){if("InvalidAccessError"==N.name)E&&(am(E),E=0),Ok(Error("An extension is blocking network request."));
...
function jr(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,Yb:a,Ea:b,Cq:!!e,headers:{},postBodyFormat:"",postBody:""};M("use_request_time_ms_header")&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(P())));return a}
...
":"+ka);if("IGNORED"===a.level)var ea=0;else a:{for(var Be=Hr(),Ce=p(Be.na),ud=Ce.next();!ud.done;ud=Ce.next()){var na=ud.value;if(H.message&&H.message.match(na.Kq)){ea=na.weight;break a}}for(var rp=p(Be.ma),Sj=rp.next();!Sj.done;Sj=rp.next()){var sp=Sj.value;if(sp.callback(H)){ea=sp.weight;break a}}ea=1}H.sampleWeight=ea;for(var tp=p(Cr),Tj=tp.next();!Tj.done;Tj=tp.next()){var Uj=Tj.value;if(Uj.Za[H.name])for(var up=p(Uj.Za[H.name]),Vj=up.next();!Vj.done;Vj=up.next()){var vp=Vj.value,Qg=H.message.match(vp.regexp);
if(Qg){H.params["params.error.original"]=Qg[0];for(var Wj=vp.groups,wp={},vd=0;vd<Wj.length;vd++)wp[Wj[vd]]=Qg[vd+1],H.params["params.error."+Wj[vd]]=Qg[vd+1];H.message=Uj.tb(wp);break}}}H.params||(H.params={});var xp=Hr();H.params["params.errorServiceSignature"]="msg="+xp.na.length+"&cb="+xp.ma.length;H.params["params.serviceWorker"]="false";y.document&&y.document.querySelectorAll&&(H.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Db("sample").constructor!==
Bb&&(H.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(H);if(0!==H.sampleWeight&&!Or.has(H.message)){if("ERROR"===h){Ir.qa("handleError",H);if(M("record_app_crashed_web")&&0===Rr&&1===H.sampleWeight)if(Rr++,M("errors_via_jspb")){var Xj=new rj;D(Xj,1,1);if(!M("report_client_error_with_app_crash_ks")){var yp=new mj;D(yp,1,H.message);var zp=new nj;G(zp,mj,3,yp);var Ap=new oj;G(Ap,nj,5,zp);var Bp=new pj;G(Bp,oj,9,Ap);G(Xj,pj,4,Bp)}var Cp=new mk;Zd(Cp,rj,20,
nk,Xj);ur(Cp)}else{var Dp={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(Dp.systemHealth={crashData:{clientError:{logMessage:{message:H.message}}}});tm("appCrashed",Dp)}Qr++}else"WARNING"===h&&Ir.qa("handleWarning",H);if(M("kevlar_gel_error_routing"))a:{var De=h;if(M("errors_via_jspb")){if(Wr())var Fp=void 0;else{var wd=new jj;D(wd,1,H.stack);H.fileName&&D(wd,4,H.fileName);var Jb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Jb.length&&(1!==
Jb.length||isNaN(Number(Jb[0]))?2!==Jb.length||isNaN(Number(Jb[0]))||isNaN(Number(Jb[1]))||(D(wd,2,Number(Jb[0])),D(wd,3,Number(Jb[1]))):D(wd,2,Number(Jb[0])));var zc=new mj;D(zc,1,H.message);D(zc,3,H.name);D(zc,6,H.sampleWeight);"ERROR"===De?D(zc,2,2):"WARNING"===De?D(zc,2,1):D(zc,2,0);var Yj=new kj;D(Yj,1,!0);Zd(Yj,jj,3,lj,wd);var bc=new gj;D(bc,3,window.location.href);for(var Gp=L("FEXP_EXPERIMENTS",[]),Zj=0;Zj<Gp.length;Zj++){var Pv=Gp[Zj];Dd(bc);Rd(bc,5,2,!1).push(Pv)}var ak=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
if(!Fk()&&ak)for(var Hp=p(Object.keys(ak)),Ac=Hp.next();!Ac.done;Ac=Hp.next()){var Ip=Ac.value,bk=new ij;D(bk,1,Ip);bk.setValue(String(ak[Ip]));ae(bc,4,ij,bk)}var ck=H.params;if(ck){var Jp=p(Object.keys(ck));for(Ac=Jp.next();!Ac.done;Ac=Jp.next()){var Kp=Ac.value,dk=new ij;D(dk,1,"client."+Kp);dk.setValue(String(ck[Kp]));ae(bc,4,ij,dk)}}var Lp=L("SERVER_NAME"),Mp=L("SERVER_VERSION");if(Lp&&Mp){var ek=new ij;D(ek,1,"server.name");ek.setValue(Lp);ae(bc,4,ij,ek);var fk=new ij;D(fk,1,"server.version");
fk.setValue(Mp);ae(bc,4,ij,fk)}var Rg=new nj;G(Rg,gj,1,bc);G(Rg,kj,2,Yj);G(Rg,mj,3,zc);Fp=Rg}var Np=Fp;if(!Np)break a;var Op=new mk;Zd(Op,nj,163,nk,Np);ur(Op)}else{if(Wr())var Pp=void 0;else{var Ee={stackTrace:H.stack};H.fileName&&(Ee.filename=H.fileName);var Kb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Kb.length&&(1!==Kb.length||isNaN(Number(Kb[0]))?2!==Kb.length||isNaN(Number(Kb[0]))||isNaN(Number(Kb[1]))||(Ee.lineNumber=Number(Kb[0]),Ee.columnNumber=Number(Kb[1])):Ee.lineNumber=
Number(Kb[0]));var gk={level:"ERROR_LEVEL_UNKNOWN",message:H.message,errorClassName:H.name,sampleWeight:H.sampleWeight};"ERROR"===De?gk.level="ERROR_LEVEL_ERROR":"WARNING"===De&&(gk.level="ERROR_LEVEL_WARNNING");var Qv={isObfuscated:!0,browserStackInfo:Ee},xd={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(xd.experimentIds=L("FEXP_EXPERIMENTS"));var hk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Fk()&&hk)for(var Qp=p(Object.keys(hk)),Bc=Qp.next();!Bc.done;Bc=Qp.next()){var Rp=
Bc.value;xd.kvPairs.push({key:Rp,value:String(hk[Rp])})}var ik=H.params;if(ik){var Sp=p(Object.keys(ik));for(Bc=Sp.next();!Bc.done;Bc=Sp.next()){var Tp=Bc.value;xd.kvPairs.push({key:"client."+Tp,value:String(ik[Tp])})}}var Up=L("SERVER_NAME"),Vp=L("SERVER_VERSION");Up&&Vp&&(xd.kvPairs.push({key:"server.name",value:Up}),xd.kvPairs.push({key:"server.version",value:Vp}));Pp={errorMetadata:xd,stackTrace:Qv,logMessage:gk}}var Wp=Pp;if(!Wp)break a;tm("clientError",Wp)}if("ERROR"===De||M("errors_flush_gel_always_killswitch"))b:if(M("migrate_events_to_ts"))c:{if(M("web_fp_via_jspb")&&
...
function Zr(a){a=p(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.Nq("ABORTED")}
...
return a.join("")}
;var cs=y.ytLoggingDocDocumentNonce_;cs||(cs=bs(),z("ytLoggingDocDocumentNonce_",cs));var ds=cs;var es={Ih:0,ke:1,ue:2,Cl:3,Kh:4,Tp:5,rm:6,bo:7,xn:8,Pn:9,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS",9:"RICH_GRID_WATCH"};function fs(a){this.i=a}
...
jq:93044,kq:93045,lq:34388,mq:17657,nq:17655,oq:39579,pq:39578,qq:77448,rq:8196,sq:11357,tq:69877,uq:8197,wq:156512,xq:156509,yq:82039};function ts(){var a=vb(us),b;return(new yf(function(c,d){a.onSuccess=function(e){fl(e)?c(new vs(e)):d(new ws("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
b=nl("//googleads.g.doubleclick.net/pagead/id",a)})).eb(function(c){c instanceof Ff&&b.abort();
return Df(c)})}
...
function Qk(){var a=Hs();if(void 0!==a)return Df(a);Gs||(Gs=ts().then(Is).eb(function(b){return Js(2,b)}));
return Gs}
...
function Ks(a,b){gl(function(){ts().then(Is,function(c){return Js(b,c)}).eb(cb)},a)}
...
function Bu(a){var b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?Ps:c;var d=Ys(b,a.o);if(!d)return Df(new Q("Error: No request builder found for command.",b));var e=d.o(b,void 0,c);return e?new yf(function(f){var g,h,k;return w(function(m){if(1==m.i){h="cors"===(null==(g=e.ta)?void 0:g.mode)?"cors":void 0;if(a.m.md){var q=e.config,r;q=null==q?void 0:null==(r=q.Pa)?void 0:r.sessionIndex;r=Os({sessionIndex:q});k=Object.assign({},Cu(h),r);return m.u(2)}return v(m,Du(e.config,
h),3)}2!=m.i&&(k=m.j);f(Eu(a,e,k));m.i=0})}):Df(new Q("Error: Failed to build request for command.",b))}
function Fu(a,b,c){var d;if(b&&!(null==b?0:null==(d=b.Rq)?0:d.Uq)&&a.l){d=p(xu);for(var e=d.next();!e.done;e=d.next())e=e.value,a.l[e]&&a.l[e].handleResponse(b,c)}}
...
case 6:V=na.j;if(M("web_one_platform_error_handling")&&(null==(nb=V)?0:null==(Xa=nb.error)?0:Xa.details))for(la=V.error.details,H=p(la),ka=H.next();!ka.done;ka=H.next())ea=ka.value,(Be=ea["@type"])&&-1<yu.indexOf(Be)&&(delete ea["@type"],V=ea);u&&a.i.has(u)&&a.i.delete(u);(null==(Ce=b.config)?0:Ce.Yc)&&Z(b.config.Yc);if(V||null==(ud=a.j)||!ud.Dq(b.input,b.ha)){na.u(7);break}return v(na,a.j.Iq(b.input,b.ha),8);case 8:V=na.j;case 7:return Fu(a,V,b),na.return(V)}})}
function Du(a,b){var c,d,e,f;return w(function(g){if(1==g.i){e=null==(c=a)?void 0:null==(d=c.Pa)?void 0:d.sessionIndex;var h=Os({sessionIndex:e});if(!(h instanceof yf)){var k=new yf(cb);zf(k,2,h);h=k}return v(g,h,2)}f=g.j;return g.return(Promise.resolve(Object.assign({},Cu(b),f)))})}
...
try{Cv("static/js/ad_status.js",b)}catch(c){}Jv.push(Xh.S(function(){if(!(Kv||"google_ad_status"in window)){try{Iv("static/js/ad_status.js",b)}catch(c){}Kv=!0;Ek("DCLKSTAT",3)}},5E3))}}}
...
function Rv(a,b,c,d){a.state=5;try{var e=new Ch({program:b,globalName:c});e.jd.then(function(){a.state=6;d&&d(b)});
a.zb(e)}catch(f){a.state=7,f instanceof Error&&Vr(f)}}
l.invoke=function(a){a=void 0===a?{}:a;var b=this.pb();if(b){var c={Nb:a};if(b.Ua)throw Error("Already disposed");a=Ah();var d;null!=(d=b.sa)&&d.j.i.Cb("/client_streamz/bg/fsc",d.Aa);d=b.nd([c.Nb,c.ld]);null!=(b=b.sa)&&(a=Ah()-a,b.l.i.fb("/client_streamz/bg/fsl",a,b.Aa));b=d}else b=null;return b};
l.dispose=function(){this.Db()};
l.Db=function(){this.zb(null);this.state=8};
l.pb=function(){return this.i};
l.zb=function(a){pe(this.i);this.i=a};function Sv(){return B("yt.abuse.playerAttLoader")||null}
function Tv(){Nv.apply(this,arguments)}
t(Tv,Nv);Tv.prototype.Db=function(){this.state=8};
Tv.prototype.pb=function(){return Sv()};
Tv.prototype.zb=function(a){pe(Sv());z("yt.abuse.playerAttLoader",a)};var Uv=new Tv;var Vv=new Nv;function Wv(){return M("use_player_abuse_bg_library")?Uv.isInitialized():Vv.isInitialized()}
function Xv(a){a=void 0===a?{}:a;M("use_player_abuse_bg_library")?(a=void 0===a?{}:a,a=Uv.invoke(a)):a=Vv.invoke(a);return a}
;function Yv(a){var b=this;var c=void 0===c?0:c;var d=void 0===d?im():d;this.m=c;this.l=d;this.j=new Bh;this.i=a;a={};c=p(this.i.entries());for(d=c.next();!d.done;a={Ba:a.Ba,La:a.La},d=c.next()){var e=p(d.value);d=e.next().value;e=e.next().value;a.La=d;a.Ba=e;d=function(f){return function(){f.Ba.sb();b.i[f.La].bb=!0;b.i.every(function(g){return!0===g.bb})&&b.j.resolve()}}(a);
e=em(d,Zv(this,a.Ba));this.i[a.La]=Object.assign({},a.Ba,{sb:d,Xa:e})}}
function $v(a){var b=Array.from(a.i.keys()).sort(function(d,e){return Zv(a,a.i[e])-Zv(a,a.i[d])});
b=p(b);for(var c=b.next();!c.done;c=b.next())c=a.i[c.value],void 0===c.Xa||c.bb||(a.l.fa(c.Xa),em(c.sb,10))}
...
im();var g={};e=p(e);for(var h=e.next();!h.done;g={Ma:g.Ma},h=e.next())g.Ma=h.value,gm(function(k){return function(){k.Ma.callback.apply(k.Ma,ia(d))}}(g));
...
t(uw,J);l=uw.prototype;l.start=function(){this.started||this.i()||(this.started=!0,this.connection.va("RECEIVING"))};
...
l.D=function(){var a=this.connection;a.i()||vi(a.j,"command",this.dc,this);this.connection=null;for(var b in this.j)this.j.hasOwnProperty(b)&&this.removeListener(b);J.prototype.D.call(this)};function xw(a,b){uw.call(this,b);this.api=a;this.start()}
...
t(zw,yw);zw.prototype.va=function(a,b){this.i()||this.l.va(this.destination,this.id,a,b)};
...
t(Aw,J);Aw.prototype.va=function(a,b,c,d){this.i()||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(JSON.stringify(a),this.origin))};
...
t(Iw,Hw);function Jw(a,b,c,d){J.call(this);var e=this;this.A=b;this.webPlayerContextConfig=d;this.da=!1;this.api={};this.W=this.s=null;this.K=new K;this.j={};this.R=this.X=this.elementId=this.ra=this.config=null;this.P=!1;this.m=this.G=null;this.la={};this.Na=["onReady"];this.lastError=null;this.Da=NaN;this.J={};this.Oa=new Iw(this);this.T=0;this.l=this.o=a;re(this,this.K);Kw(this);Lw(this);re(this,this.Oa);c?this.T=gl(function(){e.loadNewVideoConfig(c)},0):d&&(Mw(this),Nw(this))}
...
function Uw(a){if(!a.i()){var b=Sw(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);if(c){a.P=!1;if(!Ww(a,"html5_remove_not_servable_check_killswitch")){var d;if((null==b?0:b.isNotServable)&&a.config&&(null==b?0:b.isNotServable(null==(d=a.config.args)?void 0:d.video_id)))return}Zw(a)}else a.Da=gl(function(){Uw(a)},50)}}
...
l.addEventListener=function(a,b){var c=this,d=Qw(this,b);d&&(0<=eb(this.Na,a)||this.j[a]||(b=ax(this,a),this.s&&this.s(a,b)),this.K.subscribe(a,d),"onReady"===a&&this.isReady()&&gl(function(){d(c.api)},0))};
...
function ax(a,b){var c="ytPlayer"+b+a.A;a.j[b]=c;y[c]=function(d){var e=gl(function(){if(!a.i()){try{a.K.qa(b,null!=d?d:void 0)}catch(h){Vr(new Q("PlayerProxy error when creating global callback",{error:h,event:b,playerId:a.A,data:d}))}var f=a.J,g=String(e);g in f&&delete f[g]}},0);
sb(a.J,String(e))};
return c}
...
l.cancel=function(){this.G&&Iv(Tw(this),this.G);hl(this.Da);this.P=!1};
...
L("PL_ATT")&&(M("use_player_abuse_bg_library")?Uv.dispose():Vv.dispose());for(var a=Xh,b=0,c=Jv.length;b<c;b++)a.fa(Jv[b]);Jv.length=0;Hv("static/js/ad_status.js");Kv=!1;Ek("DCLKSTAT",0);qe(hx,gx);fx&&(fx.removeEventListener("onVideoDataChange",ix),fx.destroy())});
